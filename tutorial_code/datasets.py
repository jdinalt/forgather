...
def tokenize_datasetdict(dataset, tokenizer, dataset_config):
    train = tokenize_dataset(dataset["train"], tokenizer, select=dataset_config.train_select)
    validate = tokenize_dataset(dataset["validation"], tokenizer, select=dataset_config.validate_select)
