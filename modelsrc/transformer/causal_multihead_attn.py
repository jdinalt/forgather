...
class CausalMultiheadAttn(nn.Module):
    ...
    def extra_repr(self) -> str:
        ...
        return f"d_model={self.d_model}, num_heads={self.num_heads}, d_head={self.d_head}"
    ...
    def forward(self, qkv: FloatTensor, **kwargs) -> FloatTensor:
        ...
        attended_values = (
            attended_values.transpose(1, 2)  # Move seq_len back to dimension 1
            .reshape(batch_size, seq_len, d_model)  # Concatenate all heads
        )
