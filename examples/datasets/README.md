...
- **[HuggingFaceTB](./HuggingFaceTB/README.md)** - SmolLM-Corpus: curated high-quality educational and synthetic data designed for training small language models.
...
- **[open-thoughts](./open-thoughts/README.md)** - OpenThoughts3-1.2M: 1.2M reasoning conversations (math, code, science) annotated by QwQ-32B, in ShareGPT-style multi-turn format.
- **[OpenAssistant](./OpenAssistant/README.md)** - OpenAssistant: conversational AI dataset from the LAION AI community, constructed from human-annotated conversation trees.
...
- **[local_dataset](./local_dataset/README.md)** - Template project for loading local datasets via `datasets.load_from_disk`.
